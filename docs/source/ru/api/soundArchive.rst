...
``ndspy.soundArchive``: SDAT (звуковые архивы)
============================================

.. module:: ndspy.soundArchive

Модуль :py:mod:`ndspy.soundArchive` позволяет загружать и сохранять звуковые архивы
*SDAT* и файлы внутри них.

.. seealso::
    Если вы ещё не знакомы со структурой *SDAT*, прочитайте
    :doc:`приложение, объясняющее её <../appendices/sdat-structure>`.
