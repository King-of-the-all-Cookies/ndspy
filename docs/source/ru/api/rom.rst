...
РњРѕРґСѓР»СЊ :py:mod:`ndspy.rom` РїСЂРµРґРѕСЃС‚Р°РІР»СЏРµС‚ РєР»Р°СЃСЃ, РїСЂРµРґСЃС‚Р°РІР»СЏСЋС‰РёР№ ROM-С„Р°Р№Р»
...
.. note::
    ...
    Р’ РѕС‚Р»РёС‡РёРµ РѕС‚ Р±РѕР»СЊС€РёРЅСЃС‚РІР° СЂСѓРєРѕРІРѕРґСЃС‚РІ ndspy, Р°С‚СЂРёР±СѓС‚С‹

    :py:class:`NintendoDSRom` РЅРµ СѓРїРѕСЂСЏРґРѕС‡РµРЅС‹ РїРѕ Р°Р»С„Р°РІРёС‚Сѓ. РћРЅРё СЂР°СЃРїРѕР»РѕР¶РµРЅС‹ РІ С‚РѕРј

    Р¶Рµ РїРѕСЂСЏРґРєРµ, РІ РєР°РєРѕРј Р·Р°РїРёСЃР°РЅС‹ РґР°РЅРЅС‹Рµ Р·Р°РіРѕР»РѕРІРєР° ROM.
...
Измените имя ROM и сохраните файл:
...
Получите файл из ROM по его ID:
...
Замените файл в ROM по его имени и пересохраните:
...
Выведите имена всех NSBTX-файлов, найдя их по магическим байтам, а не по расширениям:
...
Загрузите ARM9-код ROM и его наложения:
