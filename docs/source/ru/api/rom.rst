...
``ndspy.rom``: ROM-Ñ„Ð°Ð¹Ð»Ñ‹
=======================

.. py:module:: ndspy.rom

ÐœÐ¾Ð´ÑƒÐ»ÑŒ :py:mod:`ndspy.rom` Ð¿Ñ€ÐµÐ´Ð¾ÑÑ‚Ð°Ð²Ð»ÑÐµÑ‚ ÐºÐ»Ð°ÑÑ, Ð¿Ñ€ÐµÐ´ÑÑ‚Ð°Ð²Ð»ÑÑŽÑ‰Ð¸Ð¹ ROM-Ñ„Ð°Ð¹Ð»
Nintendo DS.

.. note::
    
    Ð’ Ð¾Ñ‚Ð»Ð¸Ñ‡Ð¸Ðµ Ð¾Ñ‚ Ð±Ð¾Ð»ÑŒÑˆÐ¸Ð½ÑÑ‚Ð²Ð° Ñ€ÑƒÐºÐ¾Ð²Ð¾Ð´ÑÑ‚Ð² ndspy, Ð°Ñ‚Ñ€Ð¸Ð±ÑƒÑ‚Ñ‹
    :py:class:`NintendoDSRom` Ð½Ðµ ÑƒÐ¿Ð¾Ñ€ÑÐ´Ð¾Ñ‡ÐµÐ½Ñ‹ Ð¿Ð¾ Ð°Ð»Ñ„Ð°Ð²Ð¸Ñ‚Ñƒ. ÐžÐ½Ð¸ Ñ€Ð°ÑÐ¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ñ‹ Ð² Ñ‚Ð¾Ð¼
    Ð¶Ðµ Ð¿Ð¾Ñ€ÑÐ´ÐºÐµ, Ð² ÐºÐ°ÐºÐ¾Ð¼ Ð·Ð°Ð¿Ð¸ÑÐ°Ð½Ñ‹ Ð´Ð°Ð½Ð½Ñ‹Ðµ Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐ° ROM.


Ïðèìåðû
--------

Èçìåíèòå èìÿ ROM è ñîõðàíèòå ôàéë:
...
Ïîëó÷èòå ôàéë èç ROM ïî åãî ID:
...
Çàìåíèòå ôàéë â ROM ïî åãî èìåíè è ïåðåñîõðàíèòå:
...
Âûâåäèòå èìåíà âñåõ NSBTX-ôàéëîâ, íàéäÿ èõ ïî ìàãè÷åñêèì áàéòàì, à íå ïî ðàñøèðåíèÿì:
...
Çàãðóçèòå ARM9-êîä ROM è åãî íàëîæåíèÿ:
