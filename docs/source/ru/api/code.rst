...
Модуль :py:mod:`ndspy.code` позволяет загружать и сохранять исполняемые код-файлы:



*   :py:class:`MainCodeFile` используется для работы с основными ARM7 или ARM9

    кодовыми файлами.

*   :py:class:`Overlay` помогает работать с наложениями кода ARM7 или ARM9.

*   :py:func:`loadOverlayTable` и :py:func:`saveOverlayTable` загружают и сохраняют

    таблицы наложений ARM7/ARM9.
