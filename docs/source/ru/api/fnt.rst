...
``ndspy.fnt``: С‚Р°Р±Р»РёС†С‹ РёРјС‘РЅ
...
ROM-С„Р°Р№Р»С‹ (:py:mod:`ndspy.rom`) Рё Р°СЂС…РёРІС‹ *NARC* (:py:mod:`ndspy.narc`)

РёСЃРїРѕР»СЊР·СѓСЋС‚ РѕРґРёРЅ Рё С‚РѕС‚ Р¶Рµ С„РѕСЂРјР°С‚ С‚Р°Р±Р»РёС† РёРјС‘РЅ. :py:mod:`ndspy.fnt` РїСЂРµРґР»Р°РіР°РµС‚

РµРґРёРЅС‹Р№ РёРЅС‚РµСЂС„РµР№СЃ РґР»СЏ СЂР°Р±РѕС‚С‹ СЃ РЅРёРјРё.
...
.. warning::
    ...
    РќРµРєРѕС‚РѕСЂС‹Рµ РёРіСЂС‹ (РЅР°РїСЂРёРјРµСЂ, *New Super Mario Bros.*) Р·Р°РіСЂСѓР¶Р°СЋС‚ С„Р°Р№Р»С‹ РїРѕ

    Р¶С‘СЃС‚РєРѕ Р·Р°РґР°РЅРЅС‹Рј ID, Р° РЅРµ РїРѕ РёРјРµРЅР°Рј. РџСЂРё СЂРµРґР°РєС‚РёСЂРѕРІР°РЅРёРё С‚Р°Р±Р»РёС† РёРјС‘РЅ

    РЅРµ РёР·РјРµРЅСЏР№С‚Рµ СЃСѓС‰РµСЃС‚РІСѓСЋС‰РёРµ ID, РµСЃР»Рё РІС‹ РЅРµ СѓРІРµСЂРµРЅС‹, С‡С‚Рѕ РёРіСЂР° РѕР±СЂР°С‰Р°РµС‚СЃСЏ

    РїРѕ РёРјРµРЅР°Рј.



A filename table РїСЂРµРґСЃС‚Р°РІР»СЏРµС‚СЃСЏ :py:class:`Folder`. Р­С‚РѕС‚ РєР»Р°СЃСЃ РЅРµ С…СЂР°РЅРёС‚

РґР°РЅРЅС‹С… С„Р°Р№Р»РѕРІ, РѕРЅ Р»РёС€СЊ РѕРїРёСЃС‹РІР°РµС‚ РёРµСЂР°СЂС…РёСЋ РїР°РїРѕРє Рё РёРјРµРЅР° РїР°РїРѕРє Рё С„Р°Р№Р»РѕРІ.

РџРѕСЌС‚РѕРјСѓ РЅР° СЌС‚РѕР№ СЃС‚СЂР°РЅРёС†Рµ С‚РµСЂРјРёРЅС‹ "filename" Рё "file" РёСЃРїРѕР»СЊР·СѓСЋС‚СЃСЏ

РїРѕС‡С‚Рё РІР·Р°РёРјРѕР·Р°РјРµРЅСЏРµРјРѕ.
...
Имена файлов и их ID

--------------------



Важно понимать, как ID файлов связаны с именами. Ниже приведён пример

структуры каталога, в котором показаны и имена, и соответствующие ID.
...
У папок есть атрибут «первый ID» (:py:attr:`Folder.firstID`), задающий ID первого

файла внутри; на примере он показан без скобок. Файлы внутри папки получают

подряд идущие ID, отображённые в скобках.



Файлы в подпапках имеют ID больше, чем файлы в самой папке. Обычно файлы и

папки упорядочиваются в ASCII-лексикографическом порядке, но это не

обязательно.



ID, на которые ссылается таблица имён, не обязательно начинаются с 0. В ROM

наложения часто записаны как безымянные файлы, начиная с 0, поэтому таблица

имён стартует с большего номера.
